...
""" Subsampling layers, modified from icefall required by zipformer. """
...
class ConvNeXt(nn.Module):
    ...
    def __init__(
        ...
        self.pointwise_conv1 = nn.Conv2d(in_channels=channels,
...
class Conv2dSubsampling(nn.Module):
    ...
    def __init__(
        ...
        self.out_whiten = Whiten(
            num_groups=1,
            whitening_limit=ScheduledFloat((0.0, 4.0), (20000.0, 8.0),
                                           default=4.0),
            prob=(0.025, 0.25),
            grad_scale=0.02,
        )
    ...
    def get_init_states(
        ...
        cached_embed_left_pad = torch.zeros(batch_size, channels, left_pad,
                                            freq).to(device)
